...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cmyt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14380&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cmyt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cmyt` can be installed with:

```
conda install cmyt
```

It is possible to list all of the versions of `cmyt` available on your platform with:
